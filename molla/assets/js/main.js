...
/* Trying to preload anc cache mobile menu. Old code - Ark
		mobileMenu: function () {
...
end of original code - Ark  */


// Optimize mobile menu preload and cache. New piece of code - Ark
		mobileMenu: function () {
			// Load the mobile menu when the document is ready
					...
					$.ajax(
						{
							...
							success: function ( response ) {
								sessionStorage.setItem("mobileMenu", response);
								$( '.mobile-menus' ).append( response );
								addMenuArrows();
