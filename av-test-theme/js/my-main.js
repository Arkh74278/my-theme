// Main Js File
console.log("my-main.js script loaded");
...
( function ( $ ) {
	...
	var self = Molla = {
		...
		init: function () {
			...
			// Molla functions
			console.log("headerHeight function about to be called");
			self.headerHeight();
			console.log("stickyHeaderHeight function about to be called");
			self.stickyHeaderHeight();
			console.log("searchToggle function about to be called");
			self.searchToggle();
			console.log("noLink function about to be called");
			self.noLink();
			console.log("stickyHeader function about to be called");
			self.stickyHeader();
			console.log("dropdownToggle function about to be called");
			self.dropdownToggle();
			console.log("mobileMenu function about to be called");
			self.mobileMenu();
			self.sidebarTitle();
			self.sidebarCtrl();
			self.magnificPopup();
...
/* Old version of mobile menu - Ark
		mobileMenu: function () {
...
// New piece of code with preload and caching - Ark
		mobileMenu: function () {
			console.log('mobileMenu function called'); // Debug line
			$(document).ready(function() {
				if (sessionStorage.getItem("mobileMenu") === null) {
					console.log('Menu not found in sessionStorage, loading via AJAX...'); // Debug line
					if ( mobile_menu_load ) {
						$( '.mobile-menu-container' ).addClass( 'molla-loading' );
						$.ajax(
							{
								...
								success: function ( response ) {
									console.log('AJAX request completed, response length:', response.length); // Debug line
									sessionStorage.setItem("mobileMenu", response); // store the menu in sessionStorage
									$( '.mobile-menus' ).append( response );
									// Rest of your code...
								},
					...
					console.log('Menu found in sessionStorage, loading from there...'); // Debug line
					// if the menu is already in sessionStorage, use that instead
					$( '.mobile-menus' ).append(sessionStorage.getItem("mobileMenu"));
				}
			});
